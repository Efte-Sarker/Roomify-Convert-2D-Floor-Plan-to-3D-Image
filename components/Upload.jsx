      ...
      {showLoginPrompt && (
        <div style={{
          ...
          <div style={{
            ...
            <LogIn size={22} color="#18181b" strokeWidth={1.5} />
          </div>

          {/* Heading */}
          <p style={{ margin: '0 0 8px', fontSize: 16, fontWeight: 700, color: '#18181b', textAlign: 'center' }}>
            Log in to upload
          </p>

          {/* Body */}
          <p style={{ margin: '0 0 24px', fontSize: 13, color: '#71717a', lineHeight: 1.6, textAlign: 'center', maxWidth: 240 }}>
            Upload floor plans and generate AI renders after signing in.
          </p>
